...
def run_archinstall(config: InstallerConfig, console: Console) -> bool:
    ...
    try:
        ...
        # Copy post-install script to a location archinstall can access
        # After archinstall mounts the new system, we copy it there
        ...
        # Copy post-install script to the installed system
